...
public class WebTest {
    //1. Открыть страницу https://99-bottles-of-beer.net
    ...
    public void testMenuStartTitle() throws InterruptedException {
        ...
        String driverPath = "C:\\Program Files\\ChromeDriver\\chromedriver_win32\\chromedriver.exe";
        ...
        menuBrowseLanguages.click();//это клик по ссылке сверху
        //sleep(1000);
        ...
        String actualResult = h2.getText();//считывание текста
